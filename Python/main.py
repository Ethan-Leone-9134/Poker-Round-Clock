...
class MyWindow(QMainWindow):    # Creates figure window object
    ...
    def createLabels(self):
        ...
        self.timeClock.setStyleSheet("border: 2px dashed red; background-color: #a6a6a6")
        self.roundLabel.setStyleSheet("border: 2px dashed red; background-color: #a6a6a6")
        self.nextRoundLabel.setStyleSheet("border: 2px dashed red; background-color: #a6a6a6")
        self.chipDisplay.setStyleSheet("border: 2px dashed red; background-color: #a6a6a6")
